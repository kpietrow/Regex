...
thevergeSearching.py is a searcher for the TheVerge.txt file. This .py file accepts user input for the Regex() search string. TheVerge.txt is a file of source code taken from one of the web pages authored byTheVerge.